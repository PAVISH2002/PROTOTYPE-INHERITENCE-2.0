export function Simdata(){                       // function for getting the sim numbers, calling or messaging numbers
    ...
    msgorcallsummit.addEventListener('click',function(){myPhone.callOrMessage()});
}

export function callOrMessage(){                 //function for exectution of call and gathering the text data incase of message
    ...
    if(msg.checked){                              //getting the message text to be sent
        ...
        msgsubmit.addEventListener('click',function(){myPhone.forMessage()});
    }
}

export function forMessage(){                    //function for execution of message
    let myPhone=this;
    let receiver=document.getElementById('callNum').value;
    let singlesimCheck=document.getElementById('singlesim');
    let dualsimCheck=document.getElementById('dualsim');
...
export function displaySimtype(){                //function for the user to select the sim type
    ...
    simtypeButton.addEventListener('click',function(){myPhone.Simdata()});
}
